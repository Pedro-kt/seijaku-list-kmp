...
import com.yumedev.seijakulistkmp.features.home.data.datasource.PublishingMangaDataSource
...
class PublishingMangaRepositoryImpl(
    private val dataSource: PublishingMangaDataSource,
    ...
    override suspend fun getPublishingManga(page: Int, perPage: Int): Result<List<PublishingManga>> {
        return try {
            ...
            val data = dataSource.getPublishingManga(
                page = page,
                perPage = perPage,
